#!/usr/bin/python3
# coding: utf-8
#Control the overall OU simulation including COREM and NEST
import nest
...
import os
import sys
from OU_script import generateScript
...
call = "rm -r " + root + "Retina_scripts/OU_scripts"
### folder for retina scripts ###
os.system(call)
os.system("mkdir "+root+"Retina_scripts/OU_scripts")
...
for i in range(0,ganglionCells):
    g=nest.Create('corem',1,{'port':float(i),'file':"Retina_scripts/OU_scripts/OU.py"})
