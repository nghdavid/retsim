...
retina.SimTime('300') # simulation time (in ms)
...
retina.Input('sequence','input_sequences/Weberlaw/nest/',{'InputFramePeriod','100'})
...
#retina.multimeter('temporal','Ganglion cell','Input',{'x','5','y','5'},'Show','True','startTime','100')
